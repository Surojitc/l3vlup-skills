...
export const FAILURE_REASONS = Object.freeze([
  ...
  'fetch_refused', 'parse_failed', 'feed_invalid', 'unknown',
]);
 ...
 */
export function buildFailureReport({ reason, detail = '', ledger = {}, model = null, promptVersion = null, runId = null, documentsAttempted = 0 }) {
  return {
    feedVersion: FEED_VERSION,
    failed: true,
