 ...
 */
export function buildFailureReport({ reason, detail = '', ledger = {}, model = null, promptVersion = null, runId = null, documentsAttempted = 0, stage = null, coverage = [] }) {
  return {
    feedVersion: FEED_VERSION,
    failed: true,
...
export const FAILURE_REPORT_FIELDS = Object.freeze([
  ...
  'runId', 'documentsAttempted', 'stage', 'coverage', 'cost',
]);
